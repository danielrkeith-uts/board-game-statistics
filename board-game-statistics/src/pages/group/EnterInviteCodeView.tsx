	...
	return (
		<>
			<Button
				...
				onClick={handleOpenInviteCodeEntryModal}
			>
				Enter Invite Code
			</Button>
			<Modal
				show={showInviteCodeEntryModal}
				onHide={handleCloseInviteCodeEntryModal}
			>
				<form
					id={'inviteCodeEntryForm'}
					onSubmit={handleInviteCodeEntered}
				>
					...
					<Modal.Footer>
						<Button
							variant={'secondary'}
							onClick={handleCloseInviteCodeEntryModal}
						>
							Cancel
						</Button>
